...
import {JALRAKSHAK_FORMAT, Provider} from '@jalrakshak/cloud-providers';

const NAME = 'dropbox';
const DISPLAY_NAME = 'Dropbox';
const DOMAIN = 'www.dropbox.com';
const JALRAKSHAK_DROPBOX_FOLDER_LINK = `//${DOMAIN}/home/Apps`;
...
export default class DropboxProvider extends Provider {
  constructor(clientId, appName) {
    ...
    this._folderLink = `${JALRAKSHAK_DROPBOX_FOLDER_LINK}/${appName}`;
    this._path = '';
   ...
   * https://www.dropbox.com/s/bxwwdb81z0jg7pb/jalrakshak_2018-11-01T23%3A22%3A43.940Z.json?rlkey=xxx&dl=0
   * ->
   * https://dl.dropboxusercontent.com/s/bxwwdb81z0jg7pb/jalrakshak_2018-11-01T23%3A22%3A43.940Z.json?rlkey=xxx&dl=0
   * @param metadata
