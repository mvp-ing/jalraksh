...
import {Icons, IconRoundSmall, LinkRenderer, MapControlButton} from '@jalrakshak/components';
...
// convert https://raw.githubusercontent.com/jalrakshak/jalrakshak-data/master/nyctrips/config.json
// to https://github.com/jalrakshak/jalrakshak-data/blob/master/movement_pittsburgh/config.json
function getURL(url) {
  return url
    ? url
