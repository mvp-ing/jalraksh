...
export default {
  ...
  modal: {
    ...
    addStyle: {
      ...
      publishSubtitle7:
        'here. *jalrakshak is a client-side application, data stays in your browser..',
    ...
    shareMap: {
      ...
      shareDisclaimer:
        'jalrakshak will save your map data to your personal cloud storage, only people with the URL can access your map and data. ' +
        'You can edit/delete the data file in your cloud account anytime.',
      gotoPage: 'Go to your Jalrakshak.gl {currentProvider} page'
    },
    statusPanel: {
    ...
    exportMap: {
      ...
      json: {
        ...
        configDisclaimer:
          'Map config will be included in the Json file. If you are using jalrakshak in your own app. You can copy this config and pass it to ',
        selection:
          'Export current map data and config into a single Json file. You can later open the same map by uploading this file to jalrakshak.',
        disclaimer:
...
`,
    ...
    iconInfo: {
      ...
      code: 'icon',
      description2: ' jalrakshak will automatically create a icon layer for you.',
      example: 'Example:',
      icons: 'Icons'
    },
    storageMapViewer: {
    ...
    loadStorageMap: {
      back: 'Back',
      goToPage: 'Go to your Jalrakshak.gl {displayName} page',
      storageMaps: 'Storage / Maps',
      noSavedMaps: 'No saved maps yet',
      foursquareStorageMessage:
        'Only maps saved with Jalrakshak.gl > Save > Foursquare Storage option are shown here'
    }
  },
  header: {
  ...
  fileUploader: {
    ...
    disclaimer:
      '*jalrakshak is a client-side application with no server backend. Data lives only on your machine/browser. ' +
