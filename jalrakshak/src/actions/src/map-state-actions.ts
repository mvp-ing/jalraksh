...
import {Bounds, Merge, Viewport} from '@jalrakshak/types';
 ...
 * @public
 * @example
 * import {togglePerspective} from '@jalrakshak/actions';
 ...
 * @public
 * @example
 * import {fitBounds} from '@jalrakshak/actions';
 ...
 * @public
 * @example
 * import {updateMap} from '@jalrakshak/actions';
 ...
 * @public
 * @example
 * import {toggleSplitMap} from '@jalrakshak/actions';
