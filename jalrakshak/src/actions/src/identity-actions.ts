...
/**
 *
 * Add a new jalrakshak instance in `jalrakshakGlReducer`. This action is called under-the-hood when a `Jalrakshak` component is **mounted** to the dom.
 * Note that if you dispatch actions such as adding data to a jalrakshak instance before the React component is mounted, the action will not be
...
/**
 *
 * Delete an instance from `jalrakshakGlReducer`. This action is called under-the-hood when a `Jalrakshak` component is **un-mounted** to the dom.
 ...
 * Under-the-hood, when a `Jalrakshak` component is mounted or unmounted,
