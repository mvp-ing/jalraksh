 ...
 * jalrakshak instance. jalrakshak reducer will look for signatures in the action to
 ...
 * ```js
 *  {
 *    type: "@@jalrakshak/LAYER_CONFIG_CHANGE",
 *    payload: {
 *      type: '@@jalrakshak/LAYER_CONFIG_CHANGE',
 *      payload: {},
 *      meta: {
 ...
 * @example
 *
 * import {wrapTo, togglePerspective} from '@jalrakshak/actions';
 *
 * // This action will only dispatch to the Jalrakshak instance with `id: map_1`
 ...
 */
export const wrapTo = curry((id: string, action: IJalrakshakAction) => ({
 ...
 * @public
 */
export const isForwardAction = (action: IJalrakshakAction) => {
 ...
 * @public
 */
export const unwrap = (action: IJalrakshakAction) =>
 ...
 * @private
 */
export const _actionFor = (id: string, action: IJalrakshakAction) =>
 ...
 * import {toggleSplitMap, forwardTo} from '@jalrakshak/actions';
 * import {connect} from 'react-redux';
 *
 * const MapContainer = props => (
 *  <div>
 *   <button onClick={() => props.jalrakshakGlDispatch(toggleSplitMap())}/>
 *  </div>
 * )
 *
...
export const forwardTo =
  (id: string, dispatch: Dispatch<IJalrakshakAction>) => (action: IJalrakshakAction) =>
    dispatch(wrapTo(id, action));

/**
 * Update the state of a jalrakshak instance
 * @memberof forwardActions
 * @param {Object} state
 * @param {string} id
