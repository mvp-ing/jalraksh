...
/**
 * Jalrakshak.gl action types, can be listened by reducers to perform additional tasks whenever an action is called in jalrakshak
 * @constant
 * @type {Object}
 * @public
 *
 ...
 *   // listen on jalrakshak map update action to store a copy of viewport in app state
