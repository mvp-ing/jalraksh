...
import {GeoArrowArcLayer} from '@jalrakshak/deckgl-arrow-layers';
import {FilterArrowExtension} from '@jalrakshak/deckgl-layers';
import {EnhancedLineLayer} from '@jalrakshak/deckgl-layers';
...
import {LAYER_VIS_CONFIGS, PROJECTED_PIXEL_SIZE_MULTIPLIER} from '@jalrakshak/constants';
import {
  ColorRange,
  Merge,
  RGBColor,
...
import {DataContainerInterface, maybeHexToGeo} from '@jalrakshak/utils';
...
export default class LineLayer extends ArcLayer {
  ...
  static findDefaultLayerProps({fieldPairs = []}: JalrakshakTable): {
