...
import {GEOJSON_FIELDS, PROJECTED_PIXEL_SIZE_MULTIPLIER} from '@jalrakshak/constants';
...
import {default as JalrakshakTable, Datasets} from '@jalrakshak/table';
...
export default class TripLayer extends Layer {
  ...
  static findDefaultLayerProps(
    {label, fields = [], dataContainer, id}: JalrakshakTable,
    foundLayers?: any[]
  ) {
