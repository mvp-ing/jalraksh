...
import {DataContainerInterface, createDataContainer} from '@jalrakshak/utils';
...
export default class S2GeometryLayer extends Layer {
  ...
  static findDefaultLayerProps({fields = []}: JalrakshakTable) {
  ...
  calculateDataAttribute({filteredIndex}: JalrakshakTable, getS2Token) {
  ...
  updateLayerMeta(dataset: JalrakshakTable, getS2Token) {
