...
import {GeoArrowScatterplotLayer} from '@jalrakshak/deckgl-arrow-layers';
import {FilterArrowExtension} from '@jalrakshak/deckgl-layers';
...
import {default as JalrakshakTable} from '@jalrakshak/table';
...
export default class PointLayer extends Layer {
   ...
   * in deck.gl layer, see: FilterArrowExtension in @jalrakshak/deckgl-layers.
  ...
  static findDefaultLayerProps(dataset: JalrakshakTable) {
  ...
  calculateDataAttribute({filteredIndex, dataContainer}: JalrakshakTable, getPosition) {
  ...
  updateLayerMeta(dataset: JalrakshakTable) {
