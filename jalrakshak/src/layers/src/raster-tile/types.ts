...
import type {ColorMap, StacTypes} from '@jalrakshak/types';
...
export type ExtendedJalrakshakSTAC = {
...
export type GetTileDataCustomProps = Pick<AssetRequestInfo, 'loadAssetIds' | 'loadBandIndexes'> & {
  stac: CompleteSTACObject & ExtendedJalrakshakSTAC;
  colormapId: string;
...
export type JalrakshakRasterDataset = JalrakshakDataset & {
