...
import {StacTypes} from '@jalrakshak/types';
import {hexToRgb} from '@jalrakshak/utils';
 ...
 * Right now in Jalrakshak, our available methods of rendering raster data are quite simple. We only allow a user to choose among `presets`, and under the hood we select which data files to load.
