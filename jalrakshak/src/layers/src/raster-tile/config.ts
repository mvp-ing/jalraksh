...
export const rasterVisConfigs = {
  ...
  // jalrakshak's visConfig from jalrakshak https://github.com/foursquare/jalrakshak/blob/490a8938ffa1fac025e8d1997481acc1bffe4abd/src/layers/layer-factory.js#L228
  // key `colorRange` is required becuase it is hardcoded in jalrakshak
  // to make shallow copy of the visConfig item
  // https://github.com/foursquare/jalrakshak/blob/490a8938ffa1fac025e8d1997481acc1bffe4abd/src/reducers/vis-state-merger.js#L736
