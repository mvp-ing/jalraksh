...
import {DataContainerInterface, ArrowDataContainer} from '@jalrakshak/utils';
...
export default class GeoJsonLayer extends Layer {
  ...
  static findDefaultLayerProps({label, fields = []}: JalrakshakTable) {
  ...
  calculateDataAttribute(dataset: JalrakshakTable) {
  ...
  setInitialLayerConfig(dataset: JalrakshakTable) {
    const {dataContainer} = dataset;
