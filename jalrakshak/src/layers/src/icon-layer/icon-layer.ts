...
import {SvgIconLayer} from '@jalrakshak/deckgl-layers';
import IconLayerIcon from './icon-layer-icon';
import {ICON_FIELDS} from '@jalrakshak/constants';
...
import {isTest} from '@jalrakshak/utils';
import {getTextOffsetByRadius, formatTextLabelData} from '../layer-text-label';
import {default as JalrakshakTable} from '@jalrakshak/table';
import {getApplicationConfig, DataContainerInterface} from '@jalrakshak/utils';
import {
  ColorRange,
  VisConfigBoolean,
  VisConfigColorRange,
...
export default class IconLayer extends Layer {
  ...
  static findDefaultLayerProps({
    fieldPairs = [],
    fields = []
  }: JalrakshakTable): FindDefaultLayerPropsReturnValue {
  ...
  calculateDataAttribute({dataContainer, filteredIndex}: JalrakshakTable, getPosition) {
