...
import {CHANNEL_SCALES, ALL_FIELD_TYPES} from '@jalrakshak/constants';
...
import {hexToRgb, DataContainerInterface} from '@jalrakshak/utils';
...
class HeatmapLayer extends MapboxGLLayer {
  ...
  static findDefaultLayerProps(dataset: JalrakshakTable): FindDefaultLayerPropsReturnValue {
