...
import {DomainStops, Field as JalrakshakField, ZoomStopsConfig} from '@jalrakshak/types';
import {DomainQuantiles} from '@jalrakshak/utils';
...
export function isIndexedField(field?: JalrakshakField | null): boolean {
