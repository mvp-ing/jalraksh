...
import {hexToRgb, aggregate, DataContainerInterface} from '@jalrakshak/utils';
import {
  HIGHLIGH_COLOR_3D,
  CHANNEL_SCALES,
  FIELD_OPTS,
...
import {ColorRange, Field, LayerColumn, Merge} from '@jalrakshak/types';
...
export default class AggregationLayer extends Layer {
  ...
  calculateDataAttribute({filteredIndex}: JalrakshakTable, getPosition) {
