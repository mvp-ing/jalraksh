...
import { generateHashId, idToPolygonGeo } from '@jalrakshak/common-utils';
import { LAYER_TYPES } from '@jalrakshak/constants';
import { LayerHoverProp, getLayerHoverPropValue } from '@jalrakshak/reducers';
import { Feature, FeatureSelectionContext } from '@jalrakshak/types';
import {
  FloatingPortal,
  flip,
  offset,
