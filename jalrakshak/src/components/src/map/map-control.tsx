...
import JalrakshakLogo from '../common/logo';
...
import { Editor, LayerVisConfig, MapControls, MapState } from '@jalrakshak/types';
import { Datasets } from '@jalrakshak/table';
import { MapStateActions, UIStateActions } from '@jalrakshak/actions';
...
const LegendLogo = <JalrakshakLogo version={false} appName="jalrakshak" />;
