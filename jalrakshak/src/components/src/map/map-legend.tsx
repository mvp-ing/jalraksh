...
import { CHANNEL_SCALES, DIMENSIONS } from '@jalrakshak/constants';

import { Layer, LayerBaseConfig, VisualChannel, VisualChannelDescription } from '@jalrakshak/layers';
import { LayerVisConfig, MapState, RGBColor } from '@jalrakshak/types';
