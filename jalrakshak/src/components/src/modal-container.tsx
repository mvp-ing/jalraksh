...
import { ALL_FIELD_TYPES } from '@jalrakshak/constants';
import {
  exportData,
  getFileFormatNames,
  getFileExtensions,
...
import { exportHtml, exportMap, exportJson, exportImage } from '@jalrakshak/utils';
...
// Breakpoints
import { media } from '@jalrakshak/styles';
...
import { MapState, UiState, OnSuccessCallBack, OnErrorCallBack } from '@jalrakshak/types';
      ...
      if (currentModal && currentModal.id && currentModal.template) {
        ...
        switch (currentModal) {
          ...
          case EXPORT_DATA_ID:
            ...
            break;
          case EXPORT_MAP_ID: {
            const jalrakshakGlConfig = visState.schema.getConfigToSave({
              mapStyle,
              visState,
              mapState,
              uiState
