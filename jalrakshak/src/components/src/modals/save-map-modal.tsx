...
import { MAP_THUMBNAIL_DIMENSION, MAP_INFO_CHARACTER, dataTestIds } from '@jalrakshak/constants';
...
import { MapInfo, ExportImage } from '@jalrakshak/types';
import { Provider } from '@jalrakshak/cloud-providers';
import { setMapInfo, cleanupExportImage as cleanupExportImageAction } from '@jalrakshak/actions';
                ...
                {provider.getManagementUrl ? (
                  <StyledExportSection style={STYLED_EXPORT_SECTION_STYLE}>
                    <div className="selection">
                      ...
                      >
                        Go to your Jalrakshak.gl {provider.displayName} page
                      </a>
                    </div>
                  </StyledExportSection>
                ) : null}
