...
import { isPMTilesUrl, validateUrl } from '@jalrakshak/common-utils';
import { DatasetType, RasterTileType, PMTilesType } from '@jalrakshak/constants';
import { JsonObjectOrArray } from '@jalrakshak/types';
import { parseRasterMetadata, parseVectorMetadata } from '@jalrakshak/table';
...
const RASTER_TILE_DOCUMENTATION_URL =
  'https://docs.jalrakshak/docs/user-guides/c-types-of-layers/n-raster-tile-layer';
