...
import { createLinearGradient } from '@jalrakshak/utils';
import { StyledPanelHeader, StyledPanelHeaderProps } from '../../common/styled-components';
import { RGBColor, Filter, Field } from '@jalrakshak/types';
  ...
  const FilterPanelHeader: React.FC<FilterPanelHeaderProps> = ({
    ...
    return (
      <StyledFilterHeader
        ...
        $labelRCGColorValues={datasets.map((d: JalrakshakTable) => d.color)}
      >
