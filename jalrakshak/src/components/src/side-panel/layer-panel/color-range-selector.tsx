...
import { JALRAKSHAK_COLOR_PALETTES, PALETTE_TYPES, ColorPalette } from '@jalrakshak/constants';

import { ColorRange, ColorUI, NestedPartial } from '@jalrakshak/types';
import {
  hasColorMap,
...
function ColorRangeSelectorFactory(
  ...
  const ColorRangeSelector: React.FC<ColorRangeSelectorProps> = ({
    colorPalettes = JALRAKSHAK_COLOR_PALETTES,
    colorPaletteUI,
