...
import { CHANNEL_SCALES, SCALE_TYPE_NAMES } from '@jalrakshak/constants';

import { ColorUI, LayerVisConfig } from '@jalrakshak/types';
import { camelize } from '@jalrakshak/utils';
import { Layer, VisualChannel } from '@jalrakshak/layers';
...
export type DimensionScaleSelectorProps = {
  ...
  label?: string;
  dataset: JalrakshakTable | undefined;
  onChange: (
