...
import { ALL_FIELD_TYPES, SCALE_TYPES } from '@jalrakshak/constants';
import { AggregatedBin, Layer, VisualChannelDomain } from '@jalrakshak/layers';
import { JalrakshakTable } from '@jalrakshak/table';
import { ColorRange, ColorUI, Field } from '@jalrakshak/types';
import {
  getLayerColorScale,
  getLegendOfScale,
