...
import { PMTilesType } from '@jalrakshak/constants';
import {
...
import { capitalizeFirstLetter, getApplicationConfig } from '@jalrakshak/utils';
...
function RasterTileLayerConfiguratorFactory(
  ...
  const STACCheckConfiguratorWrapper = ({
    ...
    // If no dataset is loaded into Jalrakshak, stac can be undefined
    if (!stac) {
      return null;
    }
