...
import { UIStateActions, VisStateActions, MapStateActions } from '@jalrakshak/actions';

import { useSortable, SortableContext, verticalListSortingStrategy } from '@dnd-kit/sortable';
import { CSS } from '@dnd-kit/utilities';
import LayerPanelFactory from './layer-panel';
import { findById } from '@jalrakshak/utils';
import { dataTestIds } from '@jalrakshak/constants';
import { SplitMap } from '@jalrakshak/types';
    ...
    return (
      <Container>
        <SortableContext
          ...
          disabled={!isSortable}
        >
          {/* warning: containerId should be similar to the first key in dndItems defined in jalrakshak-gl.js*/}
