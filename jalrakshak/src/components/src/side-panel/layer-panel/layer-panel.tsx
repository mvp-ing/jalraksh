...
import { ActionHandler, MapStateActions, VisStateActions, toggleModal } from '@jalrakshak/actions';
...
import { ColorUI, LayerVisConfig, NestedPartial, SplitMap } from '@jalrakshak/types';
