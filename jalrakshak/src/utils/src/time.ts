...
import {toArray} from '@jalrakshak/common-utils';
import {AnimationConfig, Timeline, TimeRangeFilter, Filter} from '@jalrakshak/types';
 ...
 * @param dataset {JalrakshakTable}
 * @param filter
 */
export function getFilterMappedValue(
  dataset: JalrakshakTableModel<any, any>,
  filter: Filter
