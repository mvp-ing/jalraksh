...
import {notNullorUndefined, toArray} from '@jalrakshak/common-utils';
import {ALL_FIELD_TYPES, SCALE_FUNC, SCALE_TYPES, NO_VALUE_COLOR} from '@jalrakshak/constants';
// import {FilterProps, JalrakshakTable} from '@jalrakshak/layers';
import {
  AggregatedBin,
  ColorMap,
  ColorRange,
  HexColor,
  JalrakshakLayer as Layer,
  MapState,
  VisualChannel,
  VisualChannelDomain,
  RGBColor,
...
// TODO isolate types - depends on @jalrakshak/layers
type FilterProps = any;
type JalrakshakTable = any;
