...
import {BaseMapStyle, LayerGroup, MapState} from '@jalrakshak/types';
...
export function getStyleDownloadUrl(styleUrl, accessToken, mapboxApiUrl) {
  ...
  if (styleUrl.startsWith('mapbox://styles')) {
    ...
    // https://api.mapbox.com/styles/v1/heshan0131/cjg1bfumo1cwm2rlrjxkinfgw?pluginName=Jalrakshakgl&access_token=<token>
    return `${
      mapboxApiUrl || DEFAULT_MAPBOX_API_URL
    }/styles/v1/${styleId}?pluginName=Jalrakshakgl&access_token=${accessToken}`;
  }
