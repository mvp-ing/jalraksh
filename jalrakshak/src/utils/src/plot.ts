...
// TODO jalrakshak-table module isn't accessible from utils. Add compatible interface to types
type Datasets = any;
 ...
 * @param filter
 */
export function runGpuFilterForPlot<K extends JalrakshakTableModel<K, L>, L>(
  dataset: K,
  filter?: Filter
): number[] {
