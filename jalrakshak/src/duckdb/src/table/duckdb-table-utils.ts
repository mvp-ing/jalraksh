...
// TODO: Remove isGeoArrow* once Jalrakshak.gl is upgraded to loaders.gl 4.4+

import * as arrow from 'apache-arrow';
import {DataType} from 'apache-arrow/type';
import {DuckDBDataProtocol} from '@duckdb/duckdb-wasm';

import {GEOARROW_EXTENSIONS, GEOARROW_METADATA_KEY} from '@jalrakshak/constants';
import {ProtoDatasetField} from '@jalrakshak/types';
import {DatabaseConnection, getApplicationConfig} from '@jalrakshak/utils';
 ...
 */
export function castDuckDBTypesForJalrakshak(
  tableName: string,
