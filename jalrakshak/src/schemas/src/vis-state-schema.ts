...
import {LAYER_VIS_CONFIGS, FILTER_VIEW_TYPES} from '@jalrakshak/constants';
import {colorRangeBackwardCompatibility, isFilterValidToSave, findById} from '@jalrakshak/utils';
...
import JalrakshakGLSchema from './schema-manager';
...
export interface VisState {
  ...
  schema: typeof JalrakshakGLSchema;
