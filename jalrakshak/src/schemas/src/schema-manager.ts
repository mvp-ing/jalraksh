...
import {MapInfo, SavedVisState, SavedMapStyle, ParsedConfig, BaseMapStyle} from '@jalrakshak/types';
...
export type JalrakshakGLSchemaProps = {
...
export class JalrakshakGLSchema {
...
const JalrakshakGLSchemaManager = new JalrakshakGLSchema();

export default JalrakshakGLSchemaManager;
