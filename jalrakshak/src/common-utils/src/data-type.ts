...
import {ArrowTableInterface, ApacheVectorInterface, RowData, Field} from '@jalrakshak/types';
...
/**
 * Convert type-analyzer output to jalrakshak field types
 *
 * @param aType
 ...
 * @example
 *
 * import {getFieldsFromData} from '@jalrakshak/common-utils';
 * const data = [{
