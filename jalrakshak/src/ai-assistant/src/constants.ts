...
- For jalrakshak tools:
  ...
  3. Do not call saveToolResults after tableTool, as tableTool will automatically save the dataset to jalrakshak
...
- For data analysis:
  1. If new dataset has been generated by tools e.g. bufferTool, centroidTool, getUsCountyTool, getUsZipcodeTool, isochrone, mergeTables, etc.:
     a. Save them as a new dataset in jalrakshak first
...
export const ASSISTANT_DESCRIPTION = 'A Jalrakshak.gl AI Assistant';
