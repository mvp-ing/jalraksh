...
import { TableToolComponent } from './jalrakshak-tools/table-tool';
...
`,
  ...
  // customize a table tool from localQuery tool to create a new table/dataset in jalrakshak using SQL query
  const tableTool: LocalQueryTool = {
    ...localQuery,
    description: `Create a new table/dataset in jalrakshak using SQL query which will
