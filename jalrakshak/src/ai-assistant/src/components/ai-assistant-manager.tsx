...
import { flattenMessages } from '@jalrakshak/utils';
import { messages as jalrakshakGlMessages } from '@jalrakshak/localization';


import { MapStyle } from '@jalrakshak/reducers';
import { SidePanelTitleFactory, Icons } from '@jalrakshak/components';
...
export function AiAssistantPanel() {
  ...
  const locale = useSelector((state: State) => state.demo.jalrakshakGl.map.uiState.locale);
  ...
  // combine jalrakshakGlMessages and messages
