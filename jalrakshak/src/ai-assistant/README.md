# Jalrakshak.gl AI Assistant Module

The AI Assistant is a module that adds an AI chatbot to Jalrakshak.gl. This module aims to integrates Jalrakshak.gl with AI-powered capabilities, enabling it to interact with multiple AI models seamlessly.

## Overview

The system is designed to enable Jalrakshak.gl, a React-based single-page application, to integrate an AI Assistant Module for performing tasks with large language models (LLMs) like OpenAI GPT models, Google Gemini models, Ollama models, etc.

![image](https://github.com/user-attachments/assets/77a240f1-037f-488e-8261-b7e82c42606d)

Below is a flow map that shows how a user can update a basemap in Jalrakshak.gl through a simple AI-driven prompt, showcasing the integration of LLMs with application actions and rendering.

![image](https://github.com/user-attachments/assets/17992157-3393-4fcb-8e72-7edf46268c6c)

The AI Assistant Module also provides a set of tools to support data analysis and visualization. These AI Tools are designed to be used in conjunction with the Jalrakshak.gl application and transform jalrakshak into a powerful spatial data analysis and visualization tool. For more details about the AI Assistant Module, please to https://github.com/geodacenter/openassistant.
...
For complex tasks, the AI Assistant can use multiple tools to perform the task. For example, a user can ask the AI Assistant if the points dataset loaded in jalrakshak is clustering in zipcode areas. The AI Assistant could call the following tools to perform the task:
...
4. `saveData` to save the zipcode areas as a new GeoJSON dataset in jalrakshak
5. `spatialJoin` to count the number of points in each zipcode area
6. `saveData` to save the spatialJoin result as a new dataset in jalrakshak
...
9. `saveData` to save the local Moran's I result as a new dataset in jalrakshak
10. `addLayer` to add the local Moran's I result as a new layer in jalrakshak

![jalrakshak-vectortile-ai-3](https://github.com/user-attachments/assets/406afbfe-4671-42a6-8f38-90cdf171c363)
...
- Jalrakshak.gl Tools
  ...
  - [basemap](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/basemap-tool.tsx)
  - [mapBoundary](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/boundary-tool.tsx)
  - [addLayer](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/layer-creation-tool.tsx)
  - [updateLayerColor](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/layer-style-tool.tsx)
  - [loadData](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/loaddata-tool.tsx)
  - [saveData](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/jalrakshak-tools/savedata-tool.tsx)
...
- Query Tools
  ...
  - [filterDataset](https://github.com/jalrakshak/jalrakshak/blob/main/src/ai-assistant/src/tools/query-tool.tsx)
...
Next: [Spatial Data Analysis using Jalrakshak.gl AI Assistant](https://github.com/jalrakshak/jalrakshak/blob/main/docs/spatial-analysis-tutorial/README.md)
