...
export const ACTION_PREFIX = '@@jalrakshak/';
export const JALRAKSHAK_UNFOLDED_BUCKET = 'https://studio-public-data.foursquare.com/statics/jalrakshak';
...
export const JALRAKSHAK_NAME = 'Jalrakshak';
...
/**
 * Theme name that can be passed to `Jalrakshak` `prop.theme`.
 ...
 * @example
 * ```js
 * const Map = () => <Jalrakshak theme={THEME.light} id="map"/>
 * ```
 */
...
export function getHTMLMapModeTileUrl(mode: string): string {
  return `https://d1a3f4spazzrp4.cloudfront.net/jalrakshak/documentation/map-${mode.toLowerCase()}-mode.png`;
}
...
// Editor
export const EDITOR_LAYER_ID = 'jalrakshak_editor_layer';
