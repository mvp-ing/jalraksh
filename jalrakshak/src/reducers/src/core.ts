...
import {MapState, UiState} from '@jalrakshak/types';
...
const combined = (
  initialState: Partial<JalrakshakState> = {},
...
export const coreReducerFactory =
  (initialState: Partial<JalrakshakState> = {}, extraReducers = {}) =>
  (state, action) => {
 ...
 * @public
 */
export const mapStateLens = (reduxState: JalrakshakState) => ({mapState: reduxState.mapState});
 ...
 * @public
 */
export const mapStyleLens = (reduxState: JalrakshakState) => ({mapStyle: reduxState.mapStyle});
 ...
 * @public
 */
export const visStateLens = (reduxState: JalrakshakState) => ({visState: reduxState.visState});
 ...
 * @public
 */
export const uiStateLens = (reduxState: JalrakshakState) => ({uiState: reduxState.uiState});
 ...
 * @public
 */
export const providerStateLens = (reduxState: JalrakshakState) => ({
