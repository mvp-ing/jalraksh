...
import {MapStateActions, ReceiveMapConfigPayload, ActionTypes} from '@jalrakshak/actions';
import {MapState, Bounds, Viewport} from '@jalrakshak/types';

/**
 * Updaters for `mapState` reducer. Can be used in your root reducer to directly modify jalrakshak's state.
 * Read more about [Using updaters](../advanced-usage/using-updaters.md)
 * @public
 * @example
 *
 * import jalrakshakGlReducer, {mapStateUpdaters} from '@jalrakshak/reducers';
 * // Root Reducer
