...
import {createNotification, errorNotification, calculateExportImageSize} from '@jalrakshak/utils';
...
/**
 * Updaters for `uiState` reducer. Can be used in your root reducer to directly modify jalrakshak's state.
 * Read more about [Using updaters](../advanced-usage/using-updaters.md)
 *
 * @public
 * @example
 *
 * import jalrakshakGlReducer, {uiStateUpdaters} from '@jalrakshak/reducers';
