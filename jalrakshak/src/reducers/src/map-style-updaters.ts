...
import {ACTION_TASK, LOAD_MAP_STYLE_TASK} from '@jalrakshak/tasks';
...
/**
 * Updaters for `mapStyle`. Can be used in your root reducer to directly modify jalrakshak's state.
 * Read more about [Using updaters](../advanced-usage/using-updaters.md)
 * @public
 * @example
 *
 * import jalrakshakGlReducer, {mapStyleUpdaters} from '@jalrakshak/reducers';
 * // Root Reducer
 ...
 * It should not be called from outside jalrakshak without a valid `inputStyle` in the `mapStyle` reducer.
 * @memberof mapStyleUpdaters
 */
