...
import {LAYER_ID_LENGTH, Layer, LayerClasses} from '@jalrakshak/layers';
import {
  apply_,
  compose_,
  filterOutById,
...
import JalrakshakGLSchema, {Merger, PostMergerPayload, VisState} from '@jalrakshak/schemas';
...
import {createEffect} from '@jalrakshak/effects';
...
/**
 * Updaters for `visState` reducer. Can be used in your root reducer to directly modify jalrakshak's state.
 ...
 *          ...state.jalrakshakGl,
 *          foo: {
 *             ...state.jalrakshakGl.foo,
 *             visState: visStateUpdaters.enlargeFilterUpdater(
 *               state.jalrakshakGl.foo.visState,
 *               {idx: 0}
 *             )
 *          }
 *        }
