...
import {AGGREGATION_TYPES, LAYER_BLENDINGS, OVERLAY_BLENDINGS} from '@jalrakshak/constants';
import {CURRENT_VERSION, VisState, VisStateMergers, JalrakshakGLSchemaClass} from '@jalrakshak/schemas';
...
import {JalrakshakTable, Datasets, assignGpuChannels, resetFilterGpuMode} from '@jalrakshak/table';
...
export function parseLayerConfig(
  schema: JalrakshakGLSchemaClass,
  layerConfig: any
...
export function validateColumn(
  ...
  allFields: JalrakshakTable['fields']
): boolean {
